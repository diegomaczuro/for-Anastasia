...
public:
            ...
            : AbstractCardiacCellFactory<2>()
    {
        ...
        std::ifstream infile("heart/test/nastya2/chaste/BIDOMAIN_2D/data.csv");
...
public:
    ...
    void Test_nastya_tnnp06() throw(Exception)
    {
        ...
        HeartConfig::Instance()->SetMeshFileName("heart/test/nastya2/chaste/BIDOMAIN_2D/data", cp::media_type::Orthotropic);
        ...
        HeartConfig::Instance()->SetOutputDirectory("nastya_lr_2d_bidomain");
        ...
        VtkMeshWriter<2,2> vtk_writer("./nastya_lr_2d_bidomain/", "init_mesh_1", false);
        vtk_writer.WriteFilesUsingMesh(*p_mesh);

        VtkMeshWriter<2,2> vtk_writer2("./nastya_lr_2d_bidomain/", "init_mesh_2", false);
