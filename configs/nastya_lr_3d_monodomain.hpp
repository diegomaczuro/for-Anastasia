...
public:
            ...
            : AbstractCardiacCellFactory<3>()
    {
        ...
        std::ifstream infile("heart/test/nastya2/chaste/MONODOMAIN_3D/data.csv");
...
public:
    ...
    void Test_nastya_tnnp06() throw(Exception)
    {
        ...
        HeartConfig::Instance()->SetMeshFileName("heart/test/nastya2/chaste/MONODOMAIN_3D/data", cp::media_type::Axisymmetric);
        ...
        HeartConfig::Instance()->SetOutputDirectory("nastya_lr_3d_monodomain");
        ...
        VtkMeshWriter<3,3> vtk_writer("./nastya_lr_3d_monodomain/", "init_mesh_1", false);
        vtk_writer.WriteFilesUsingMesh(*p_mesh);

        VtkMeshWriter<3,3> vtk_writer2("./nastya_lr_3d_monodomain/", "init_mesh_2", false);
